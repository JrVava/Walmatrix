...
const revokedTokens_1 = require("./revokedTokens");
...
const loggingMiddleware = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        jwtPayload = (0, jwt_1.verifyToken)(token);
        const email = jwtPayload.email;
        req.headers['email'] = email;
        const dataSourceObj = new connection_1.DataSourceConnection();
        const usersRepository = (yield dataSourceObj.publicConnection()).getRepository(Users_1.Users);
        ...
        const userData = yield usersRepository
            ...
            .getRawOne();
        if (userData) {
            req.headers['store_name'] = (userData === null || userData === void 0 ? void 0 : userData.store_name)
                ? userData === null || userData === void 0 ? void 0 : userData.store_name
                : 'public';
            const stripeObj = {
                stripe_customer_id: userData.stripe_customer_id,
                stripe_price_id: userData.stripe_price_id,
                stripe_id: userData.stripe_id,
                stripe_amount: userData.stripe_amount === null
                    ? 0
                    : userData.stripe_amount,
                stripe_plan: userData.stripe_plan,
                interval: userData.interval,
                no_of_orders: userData.no_of_orders === null ? 0 : userData.no_of_orders,
                no_of_users: userData.no_of_users === null ? 0 : userData.no_of_users,
            };
